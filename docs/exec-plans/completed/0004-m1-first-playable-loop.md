...
- Both export commands correctly propagate a nonzero Godot error because the host does not have 4.7.1 export templates. Windows launch under Steam Deck Proton and the ten-minute physical-controller playthrough remain hardware validation work, not repository implementation gaps.
