...
const PROFILES: Dictionary = {
	"player": {"foot_y": 9.0, "radius": 15.0, "scale_y": 0.17, "opacity": 0.22},
	"enemy": {"foot_y": 8.0, "radius": 15.0, "scale_y": 0.18, "opacity": 0.21},
	"ranged_enemy": {"foot_y": 8.0, "radius": 15.0, "scale_y": 0.18, "opacity": 0.21},
	"resident": {"foot_y": 8.0, "radius": 12.0, "scale_y": 0.17, "opacity": 0.19},
	"resource": {"foot_y": 7.0, "radius": 22.0, "scale_y": 0.16, "opacity": 0.2},
	"obstacle": {"foot_y": 7.0, "radius": 16.0, "scale_y": 0.16, "opacity": 0.18},
	"living_prop": {"foot_y": 8.0, "radius": 20.0, "scale_y": 0.16, "opacity": 0.18},
	"summon": {"foot_y": 7.0, "radius": 14.0, "scale_y": 0.17, "opacity": 0.2},
}
...
static func validate_profiles() -> Array[String]:
	...
	for profile_id: String in PROFILES:
		...
		if float(value.get("foot_y", -1.0)) < 0.0 or float(value.get("foot_y", -1.0)) > 10.0:
			errors.append("contact shadow must overlap the authored ground baseline: %s" % profile_id)
